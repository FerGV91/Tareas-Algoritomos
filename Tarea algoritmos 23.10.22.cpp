	...
	case 1: system("cls");cout<<"Operaciones basicas: "<<endl;
{
	...
	if (op==1){
		...
		int num1=0,num2=0,res;
			cout<<"                           "<<endl;
			cout<<"Por favor ingresa el primero digito: "<<endl;
			cin>>num1;
			cout<<"Por favor ingresa el segundo digito: "<<endl;
			cin>>num2;
			res=num1+num2;
	...
	cout<<"                           "<<endl;
		...
		int num3=0,num4=0,resu;
			cout<<"                           "<<endl;
			cout<<"Por favor ingrese el primero digito: "<<endl;
			cin>>num3;
			cout<<"Por favor ingrese el segundo digito: "<<endl;
			cin>>num4;
			resu=num3-num4;
...
{	
	cout<<"                           "<<endl;
	cout<<"Bienvenido, este es un conversor de medidas, por favor ingrese el sistema de medicion que desea utilizar"<<endl;
	int medida;
	...
	{
		cout<<"                               "<<endl;
		cout<<"Por favor ingresa la medida en kilometros: ";
		cin>>km;
		mi=km*0.621371;
		cout<<"                               "<<endl;
	...
	{	cout<<"                               "<<endl;
		cout<<"Por favor ingresa la medida en metros: ";
		cin>>me;
		pu=me*39.3701;
		cout<<"                               "<<endl;
	...
	{	cout<<"                               "<<endl;
		cout<<"Por favor ingresa las libras: ";
		cin>>lib;
		kg=lib*2.2;
		cout<<"                               "<<endl;
	...
	{	cout<<"                               "<<endl;
		cout<<"Por favor ingresa la medida en millas: "<<endl;
		cin>>mi;
		km=mi*1.6;
		cout<<"                               "<<endl;
	...
	{	cout<<"                               "<<endl;
		cout<<"Por favor ingresa la medida en pulgadas: ";
		cin>>pu;
		me=pu*0.025;
		cout<<"                               "<<endl;
	...
	{	
		cout<<"                               "<<endl;
		cout<<"Por favor ingresa los kilos: ";
		cin>>kg;
		lib=kg*0.45;
		cout<<"                               "<<endl;
		cout<<kg<<" kilos es igual a "<<lib<<" libras"<<endl;
	}	break;
		default: cout<<"Lo sentimos, esa no es una opcion"<<endl;
	}
	...
	case 4: system("cls");cout<<"Determinar si una palabra o un numero es palindromo: "<<endl;
{
    ...
    int aux = 0, igual = 0;
    cout<<"                           "<<endl;
    cout << "Por favor ingresa la palabra o numero que desea evaluar: ";
	...
	case 6: system("cls");cout<<"Conversion de numeros enteros a letras: "<<endl;
{
    ...
    cin>>x;
if((x<1)||(x>999)) cout<<"Por favor ingresa un numero del 1 al 999\n";
else
	...
	case 7: system("cls");cout<<"Conversion de numeros enteros con decimal a letras: "<<endl;
{
		cout<<"                           "<<endl;
		int x,y;
    cout<<"Por favor ingrese el numero antes del punto"<<endl;
    cin>>x;
    cout<<"Por favor ingrese el numero despues del punto:"<<endl;
    cin>>y;
if((x<1)||(x>999)) cout<<"Por favor ingresa un numero del 1 al 999\n";
else
	...
	cin.ignore();
	cout<<" PUNTO ";
	if((y<1)||(y>999)) cout<<"Por favor ingresa un número del 1 al 999\n";
	else
    {
	...
	case 8: system("cls");cout<<"Una tabla de multiplicar personalizada: "<<endl;
{
	...
	cout<<"Por favor ingresa la tabla que deseas ver:";
	cin>>tabla;
	...
	case 11: system("cls");cout<<"Conversion de numeros decimales a binario: "<<endl;
{
	...
	cout<<"Por favor escribe el numero que deseas convertir: "<<endl;
	cin>>decimal;
	...
	case 12: system("cls");cout<<"Conversion de numeros decimales a hexadecimales"<<endl;
{
	cout<<"                           "<<endl;
 	int digitoex[20];
    int decimal, residuo, resultado, i = 0;

    cout << "Por favor ingresa el numero decimal a convertir: " << endl;
    cin >> decimal;
	...
	case 13: system("cls");cout<<"Crear figuras geometricas basicas: "<<endl;
{
	cout<<"                           "<<endl;
		int x;
		cout<<"\tEste programa es para crear figuras basicas "<<endl;
		cout<<"                           "<<endl;
		...
		{	int lado;
			cout<<"                           "<<endl;
			cout<<"Por favor ingresa el tamaño de una de las caras del cuadrado: ";
			cout<<"                           "<<endl;
			cin>>lado;
		...
		{	int ladoc, ladol;
			cout<<"                           "<<endl;
			cout<<"Por favor ingresa el tamaño la cara larga del rectangulo: ";
			cin>>ladol;
			cout<<"                           "<<endl;
			cout<<"Por favor ingrese el tamaño de la cara corta del rectangulo: ";
			cout<<"                           "<<endl;
			cin>>ladoc;
		...
		if (x==4)
		{	int n;
			cout<<"Por favor ingresa el tamaño del circulo: ";
			cin>>n;
			for (int f=0;f<=n;f++){
				for(int c=0; c<=n;c++){
	...
	{
		cout<<endl;
		cout<<" Ing. disculpe, este ejercicio no me salio "<<endl;
	system("pause");
	break;
	}

	case 15: system("cls");cout<<"Cajero Automatico: "<<endl;
{	cout<<"                           "<<endl;

	int saldo_inicial = 1000,opc;
	float extra,saldo = 0,retiro; 
	
	cout<<"\tBienvenido al cajero automatico UMG"<<endl;
	cout<<"1. Ingreso a la cuenta"<<endl;
	...
	switch(opc){
		...
		case 2: cout<<"\nCuanto dinero desea retirar: "; 
				...
				if(retiro > saldo_inicial){
					cout<<"Lo sentimos, su saldo es insuficiente";
				}
				else{
		...
		case 3: break;
		dafault: cout<<"Lo sentimos, usted a ingresado opcion de menu invalida, intente con otra opcion";break;
	}
		system("pause");
	break;
}
...
{
{
	...
	cout<<"                     "<<endl;
	cout<<"Por favor ingresa el primer cateto: ";
	cin>>cateto_1;
	cout<<"Por favor ingresa el segundo cateto: ";
	cin>>cateto_2;
	...
	default: system("cls");cout<<"Lo sentimos, esa no es una opcion valida"<<endl;
}

	cout<<"                                          "<<endl;
	cout<<"Si desea regresar al menu ingrese 'f'\n";
	cout<<"Si desea salir por favor ingrese cualquier caracter \n";
	cin>>salir;
	system("cls");
}while(salir=='f');
